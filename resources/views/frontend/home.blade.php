        ...
        <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
            ...
            <div class="tab-content">
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-lg-6">
                            <div class="d-flex align-items-center">
                                <img class="flex-shrink-0 img-fluid rounded" src="{{ asset('frontend/img/menu-1.jpg') }}" alt=""
                                     style="width: 80px;">
                ...
                <div id="tab-2" class="tab-pane fade show p-0">
                    <div class="row g-4">
                        <!-- Content for Lunch tab goes here -->
                    </div>
                </div>
                <div id="tab-3" class="tab-pane fade show p-0">
                    <div class="row g-4">
                        <!-- Content for Dinner tab goes here -->
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="container">
                ...
                <div class="row g-4">
                    <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        ...
                        @foreach($ourchef as $chef)
    <div class="rounded-circle overflow-hidden m-4">
        <img class="img-fluid" src="{{ asset('storage/' . $chef->image_path) }}" alt="{{ $chef->full_name }}">
    </div>
    <h5 class="mb-0">{{ $chef->full_name }}</h5>
